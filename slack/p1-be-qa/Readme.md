...
* ~~Checksum: wait 30sec and start list again ensure nothing comes back.~~ 04/14/2016
...
1. The file purported to be in the meta data exists in S3 (expensive I know :cry: )
